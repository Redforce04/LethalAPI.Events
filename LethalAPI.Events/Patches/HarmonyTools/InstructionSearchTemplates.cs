// -----------------------------------------------------------------------
// <copyright file="InstructionSearchTemplates.cs" company="LethalAPI Event Team">
...
public static class InstructionSearchTemplates
{
    ...
    {
        /// <summary>
        /// Gets <see cref="LethalAPI.Events.Patches.HarmonyTools.InstructionsToSearch"/> information for 'for' loops that refer to a instance.
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// </code>
        /// </example>
        public static LethalAPI.Events.Patches.HarmonyTools.InstructionsToSearch NonStatic
        {
            get
            {
                LethalAPI.Events.Patches.HarmonyTools.InstructionsToSearch start = Static;
        ...
        /// <summary>
        /// Gets <see cref="LethalAPI.Events.Patches.HarmonyTools.InstructionsToSearch"/> information for 'for' loops that refer to static instances.
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// </code>
        /// </example>
        public static LethalAPI.Events.Patches.HarmonyTools.InstructionsToSearch Static =>
