...
public static class EventTranspilerInjector
{
    ...
    /// <param name="prefixInstructions">
    ///     Optional instructions that can be inject prior to the event constructor, that allow loading the stack with parameters for the constructor.
    ///
    ///     Note: these instructions are injected prior to to any of the autogenerated instructions. This means that they must be first in the constructor.
    /// </param>
