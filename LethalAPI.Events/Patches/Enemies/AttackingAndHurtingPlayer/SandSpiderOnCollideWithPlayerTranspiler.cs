// -----------------------------------------------------------------------
// <copyright file="SandSpiderOnCollideWithPlayerTranspiler.cs" company="LethalAPI Event Team">
...
[EventPatch(typeof(Handlers.Enemies), nameof(Handlers.Enemies.DeniableEnemyKillingPlayer))]
internal static class SandSpiderOnCollideWithPlayerTranspiler
{
    [HarmonyTranspiler]
